...
try:
    ...
    def fit_momentum(self, data_list, start, end, opt, label):
        ...
        for i, data in enumerate(data_list):
            ...
            ax1.set_xlabel(str(label),fontsize=mpl.rcParams.get('axes.titlesize', 24))
            ax1.set_ylabel('Events per bin',fontsize=mpl.rcParams.get('axes.titlesize', 24))
            #ax1.set_yscale('log')
            #ax1.legend()
            ...
            props = dict(boxstyle='round', facecolor=colors[i], alpha=0.0)
